...
## I think Components, GameObjects, and Scenes like a theater
  ...
  Without Components, the actors canâ€™t perform; without GameObjects, there are no actors; and without Scenes, thereâ€™s no place for the story to act. All three work together like a live performance: actors (GameObjects) use their abilities (Components) to act, and all of these happened on the stage (Scene), creating the good performance for the audiences and also game players.
>>>>>>> be92129d942f7249f5f14439120410a6c79f6780
